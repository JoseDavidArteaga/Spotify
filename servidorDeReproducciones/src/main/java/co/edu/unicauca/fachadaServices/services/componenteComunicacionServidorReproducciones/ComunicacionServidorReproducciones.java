...
public class ComunicacionServidorReproducciones {
   ...
   private final ReproduccionesRemoteClient client;
    ...
    public List<ReproduccionesDTOInput> obtenerReproduccionesRemotas(Integer idUsuario){
        try {
            List<ReproduccionesDTOInput> reproducciones = client.obtenerReproducciones(idUsuario);
